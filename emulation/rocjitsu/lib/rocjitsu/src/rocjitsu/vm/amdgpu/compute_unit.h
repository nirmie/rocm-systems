...
public:
  ...
  /// @brief Number of lane elements stored in each physical VGPR.
...
///
/// @details VGPR storage is always 64 lanes wide because the SIMD fast-path
/// exposes VGPRs as VgprStorage. The active lanes for a dispatch still come
/// from the kernel descriptor and are stored on each Wavefront.
